<!doctype html>
<x-header title="add ticket type" />
                                ...
                                <div class="card h-100">
                                    <div class="card-header d-flex justify-content-between">
                                        <div class="card-title mb-0">
                                            <h5 class="mb-1 me-2">Add ticket type</h5>
                                        </div>

                                    </div>
                                    <div class="card-body">
                                        <form class="row" enctype="multipart/form-data" action="/admin/tickettype/store" method="post">
                                            @csrf
                                            ...
                                            <div class="form-floating col-lg-5 m-1">
                                                <input type="text" class="form-control" value="{{ old('benefits') }}" id="benefits" name="benefits"
                                                    placeholder="eg popcorn,candy" aria-describedby="floatingInputHelp" />
                                            ...
                                            <textarea placeholder="Enter description" class="form-control col-lg-12 mt-3" cols="30" rows="5" name="description" id="description">{{ old('description') }}</textarea>
                                            ...
                                            @enderror
                                            <input class="btn btn-primary m-3" name="submit" type="submit" value="add ticket type">
                                        </form>
                                    </div>
                                </div>
                            </div>
