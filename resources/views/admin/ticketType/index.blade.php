<!doctype html>
<x-header title="all ticket types" />
                                ...
                                <div class="card h-100">
                                    <div class="card-header d-flex justify-content-between">
                                        <div class="card-title mb-0">
                                            <h5 class="mb-1 me-2">all ticket types</h5>
                                        </div>
                                        @if ( session("message"))
                                                ...
                                                <table id="basic" class="table dataTable border "
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th data-dt-column="0" rowspan="1" colspan="1"
                                                                class="dt-orderable-asc dt-orderable-desc dt-ordering-asc"
                                                                aria-sort="ascending">benefits</th>
                                                            <th data-dt-column="0" rowspan="1" colspan="1"
                                                                class="dt-orderable-asc dt-orderable-desc dt-ordering-asc"
                                                                aria-sort="ascending">description</th>
                                                    ...
                                                    <tbody class="table-border-bottom-0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="sorting_1">
                                                                <span>{{ Str::words( $type->description,10, '...')}}</span>
                                                            </td>
                                                            <td>
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item"
                                                                            href="/admin/tickettype/{{$type->id }}/edit"><i
                                                                                class="icon-base bx bx-edit-alt me-1"></i>
                                                                            Edit</a>
                                                                        <form action="/admin/tickettype/{{$type->id }}" method="post">
                                                                            @csrf
                                                                            @method("delete")
                                                                        ...
                                                                        <a class="dropdown-item"
                                                                            href="/admin/tickettype/{{ $type->id }}"><i
