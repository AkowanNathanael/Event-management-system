                                ...
                                <div class="card h-100">
                                    <div class="card-header d-flex justify-content-between">
                                        <div class="card-title mb-0">
                                            <h5 class="mb-1 me-2">View venue</h5>
                                        </div>
                                    ...
                                    <div class="card-body">
                                        <div class="card mb-6 shadow border">
                                            <div class="card-body">
                                                ...
                                                <div class="card-subtitle mb-4">{{ $venue->created_at->diffForHumans() }}</div>

                                                <p class="card-text">
                                                  <i class="fas fa-city"></i> {{ $venue->city }}
                                                </p>
                                                <p class="card-text">
                                                ...
                                                <a href="/admin/venue/{{ $venue->id }}/edit" class="card-link inline-block btn btn-success">edit</a>
