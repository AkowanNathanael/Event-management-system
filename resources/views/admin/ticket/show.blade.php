                                    ...
                                    <div class="card-body">
                                        <div class="card mb-6 shadow border">
                                            <div class="card-body">
                                                ...
                                                <p class="card-text">
                                                    <span class="btn btn-primary p-1"> start:{{ $event->start }} </span>
                                                    <span class="btn btn-success p-1"> end:{{ $event->end }} </span>
                                                    <span class="btn btn-secondary p-1"> end:{{ $event->status }} </span>
                                                </p>
