                                ...
                                <div class="card h-100">
                                    ...
                                    <div class="card-body">
                                        <form class="row" action="/admin/category/{{ $category->id }}" method="post">
                                            ...
                                            <textarea placeholder="type here" class="form-control col-lg-11 m-1" name="description" id="description" cols="30" rows="10">{{ $category->description }}
                                            </textarea>
                                            @error("description")
                                            <p class="text-danger">
                                                {{ $message }}
                                            ...
                                            <input class="btn btn-primary m-3" name="update" type="submit" value="update cetegory">
                                        </form>
                                    </div>
                                </div>
                            </div>
