                                ...
                                <div class="card h-100">
                                    <div class="card-header d-flex justify-content-between">
                                        <div class="card-title mb-0">
                                            <h5 class="mb-1 me-2">all artist</h5>
                                        </div>
                                        @if ( session("message"))
                                                ...
                                                <table id="basic" class="table dataTable border "
                                                    ...
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th data-dt-column="0" rowspan="1" colspan="1"
                                                                class="dt-orderable-asc dt-orderable-desc dt-ordering-asc"
                                                                aria-sort="ascending">genre</th>
                                                            <th data-dt-column="0" rowspan="1" colspan="1"
                                                                class="dt-orderable-asc dt-orderable-desc dt-ordering-asc"
                                                                aria-sort="ascending">bio</th>
                                                            <th data-dt-column="0" rowspan="1" colspan="1"
                                                                class="dt-orderable-asc dt-orderable-desc dt-ordering-asc"
                                                                aria-sort="ascending">image</th>
                                                            <th data-dt-column="0" rowspan="1" colspan="1"
                                                                class="dt-orderable-asc dt-orderable-desc dt-ordering-asc"
                                                                aria-sort="ascending">website</th>
                                                    ...
                                                    <tbody class="table-border-bottom-0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="sorting_1">
                                                                <span>{{ Str::words( $artist->bio,10, '...')}}</span>
                                                            </td>
                                                            <td class="sorting_1">
                                                                @if ($artist->image && file_exists(public_path('storage/' . $artist->image)))
                                                                    <img width="50px" height="50px" src="{{ asset('storage/' . $artist->image) }}" alt="{{ $artist->name }}" class="img-fluid" />
                                                                @else
                                                                    <img width="50px" height="50px" src="{{ asset('no-image.png') }}" alt="default image" class="img-fluid" />
                                                                @endif
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item"
                                                                            href="/admin/artist/{{$artist->id }}/edit"><i
