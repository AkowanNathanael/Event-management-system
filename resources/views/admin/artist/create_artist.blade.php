                                ...
                                <div class="card h-100">
                                    <div class="card-header d-flex justify-content-between">
                                        <div class="card-title mb-0">
                                            <h5 class="mb-1 me-2">Add Artist</h5>
                                        </div>

                                    </div>
                                    <div class="card-body">
                                        <form class="row" enctype="multipart/form-data" action="/admin/artist/store" method="post">
                                            @csrf
                                            ...
                                            <div id="image-box" class="form-floating col-lg-7 m-1">
                                                <input accept="image/*" type="file" class="form-control" value="{{ old('image') }}" id="image" name="image"
                                            ...
                                            <div class="form-floating col-lg-5 m-1">
                                                <input type="url" class="form-control" value="{{ old('website') }}" id="website" name="website"
                                            ...
                                            <textarea placeholder="Enter artist bio" class="form-control col-lg-12 mt-3" cols="30" rows="5" name="bio" id="bio">{{ old('bio') }}</textarea>
                                            ...
                                            @enderror
                                            <input class="btn btn-primary m-3" name="submit" type="submit" value="add artist">
                                        </form>
                                    </div>
                                </div>
                            </div>
