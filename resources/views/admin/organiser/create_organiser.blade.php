                                ...
                                <div class="card h-100">
                                    <div class="card-header d-flex justify-content-between">
                                        <div class="card-title mb-0">
                                            <h5 class="mb-1 me-2">Add organiser</h5>
                                        </div>

                                    </div>
                                    <div class="card-body">
                                        <form class="row" enctype="multipart/form-data" action="/admin/organiser/store" method="post">
                                            @csrf
                                            ...
                                            <div class="form-floating col-lg-5 m-1">
                                                <input type="text" max="10" min="10" class="form-control" value="{{ old('phone') }}" id="phone" name="phone"
                                            ...
                                            <div id="image-box" class="form-floating col-lg-12 m-1">
                                            ...
                                            <input class="btn btn-primary m-3" name="submit" type="submit" value="add organiser">
                                        </form>
                                    </div>
                                </div>
                            </div>
