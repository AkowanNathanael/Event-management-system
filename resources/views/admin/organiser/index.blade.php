                                ...
                                <div class="card h-100">
                                    <div class="card-header d-flex justify-content-between">
                                        <div class="card-title mb-0">
                                            <h5 class="mb-1 me-2">all organisers</h5>
                                        </div>
                                        @if ( session("message"))
                                                ...
                                                <table id="basic" class="table dataTable border "
                                                    ...
                                                    <tbody class="table-border-bottom-0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="">
                                                                @if ($organiser->image && file_exists(public_path('storage/' . $organiser->image)))
                                                                <img id="image_hover" width="50px" height="50px" src="{{ asset('storage/' . $organiser->image) }}" alt="{{ $organiser->name }}" class="img-fluid" />
                                                                @else
                                                                ...
                                                                <div class="dropdown">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a class="dropdown-item"
                                                                            href="/admin/organiser/{{$organiser->id }}/edit"><i
                                                                        ...
                                                                        <a class="dropdown-item"
                                                                            href="/admin/organiser/{{ $organiser->id }}"><i
