...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <!-- Pages -->
        <li class="menu-item">
            <a href="/admin/venue/create" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-dock-top"></i>
                <div class="text-truncate" data-i18n="Account Settings">Add Venue</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="/admin/venue" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-lock-open-alt"></i>
                <div class="text-truncate" data-i18n="Authentications">venue list</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="/admin/artist/create" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-lock-open-alt"></i>
                <div class="text-truncate" data-i18n="Authentications">Add artist</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="/admin/artist" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-lock-open-alt"></i>
                <div class="text-truncate" data-i18n="Authentications">artist list</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="/admin/ticket/create" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-lock-open-alt"></i>
                <div class="text-truncate" data-i18n="Authentications">Add ticket</div>
            </a>
        </li>
        <li class="menu-item">
        ...
        <li class="menu-item">
            <a href="/admin/tickettype/create" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-lock-open-alt"></i>
                <div class="text-truncate" data-i18n="Authentications">Add ticket type</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="/admin/tickettype" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-lock-open-alt"></i>
                <div class="text-truncate" data-i18n="Authentications">ticket type list</div>
            </a>
        </li>
        <li class="menu-item">
        ...
        <li class="menu-item">
            <a href="/admin/organiser/create" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-lock-open-alt"></i>
                <div class="text-truncate" data-i18n="Authentications">Add organiser</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="/admin/organiser" class="menu-link ">
                <i class="menu-icon tf-icons bx bx-lock-open-alt"></i>
                <div class="text-truncate" data-i18n="Authentications">organiser list</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
